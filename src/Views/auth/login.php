...
<div class="flex justify-center my-10">
    <form class="text-center bg-white bg-opacity-20 rounded p-10 w-3/4 md:w-3/5 lg:w-1/2 xl:w-1/3" action="/login" method="post">
        <div class="mb-8">
            <h1 class="text-xl sm:text-2xl font-bold uppercase">Se connecter</h1>
        </div>
        ...
        <p class="text-red-500 mt-2"><?php echo error("identifiant")?></p>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="submit">Se connecter</button>
    </form>
</div>
